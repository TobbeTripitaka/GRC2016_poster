...
print 'LAB depth from %s to %s ' %(min_f, max_f)
...
im = map.imshow(plotdata, vmin = min_f, vmax = max_f, cmap = plt.cm.viridis) #viridis, magma
cb = fig.colorbar(im, orientation='horizontal',fraction=0.046, pad=0.04)
cb.ax.tick_params(labelsize=24)             
cb.ax.yaxis.set_tick_params(color='w')


plt.savefig('fig/An_LAB.png', bbox_inches='tight',transparent=True)
